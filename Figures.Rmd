...
#Figure 2A - Volcano Plot in PDAC
```{r}
...
volcano
ggsave("../SMNDC1-final/Figures/2A_Pan_DESEQ_Volcano.pdf",width=1.5,height=1.5)
```

#Figure 2B - Volcano Plot in Ov
```{r}
rm(list=ls())
...
volcano<-res_df %>%
  ...
  theme(legend.position = "none",
        ...
        legend.background = element_blank())
volcano
ggsave("../SMNDC1-final/Figures/2B_Ov_DESEQ_Volcano.pdf",width=1.5,height=1.5)
```

#Fig 2C-Overlaping GE between PDAC & Ov
```{r}
rm(list=ls())
...
ggVennDiagram(Up_list,color="black",label_alpha = 0,label_size = 2,edge_size = 0.5,set_size=2,label = "count")+
...
ggsave("Figures/2C_Upregulated_Overlaps.pdf",width=1.5,height=0.75)
  
ggVennDiagram(Down_list,color="black",label_alpha = 0,label_size = 2,edge_size = 0.5,set_size=2,label = "count")+
  ...
  theme(panel.background = element_blank(), 
        ...
        legend.background = element_blank(),
        axis.title = element_text(size=1, color="black"))
ggsave("Figures/2C_DownRegulated_Overlaps.pdf",width=1.5,height=0.75)
...
ggplot(df, aes(NES, -log10(FDR.q.val))) + 
  ...
  theme(axis.text=element_text(size=6, color="black"), 
        ...
        plot.background = element_blank(), 
        panel.border = element_blank())
ggsave("Figures/2D_GSEA_Pan.pdf",width=1.5,height=1.5)
```
...
ggplot(df, aes(NES, -log10(FDR.q.val))) + 
  ...
  theme(axis.text=element_text(size=6, color="black"), 
        ...
        plot.background = element_blank(), 
        panel.border = element_blank())
ggsave("Figures/2E_GSEA_Ov.pdf",width=1.5,height=1.5)
```

#Fig 2F- GSEA Plot of selected pathway

#Fig 2G- Splicing Distributions
```{r}
rm(list=ls())
...
ggplot(Common_Events, aes(Pan))+
  ...
  theme(axis.text.x=element_text(size=2.5, color="black"), 
...
ggsave("Figures/2G_Del_PSI_Dist_Pan.pdf",width=2.1,height=0.75)
...
ggplot(Common_Events, aes(Ov))+
  ...
  theme(axis.text.x=element_text(size=2.5, color="black"), 
        ...
        axis.ticks.y=element_blank(),
        axis.line.y = element_blank())
ggsave("Figures/2G_Del_PSI_Dist_Ov.pdf",width=2.1,height=0.75)

```

#Fig 2G- Splicing Distributions-Bar Plot
```{r}
rm(list=ls())
Pancreatic_Events<-read.table("Summary_Files/All_Events_Pan.txt",header=T)
Ovarian_Events<-read.table("Summary_Files/All_Events_Ov.txt",header=T)
...
ggsave("Figures/2G_Common_Events_Distribution.pdf",width=3,height=1.5)
```

#Figure 2H- PSI Scatter Plot
```{r}
rm(list=ls())
Pancreatic_Events<-read.table("Summary_Files/All_Events_Pan.txt",header=T)
Ovarian_Events<-read.table("Summary_Files/All_Events_Ov.txt",header=T)
...
ggplot(Common_Events,aes(x = Pan,y = Ov,color=Color,fill = Color))+
...
ggsave("Figures/2H_Common_Events_PSI.pdf",width=1.5,height=1.5)
```

#Figure 2I - Overlap Between AS and GE Genes (PDAC)
```{r}
rm(list=ls())
Pancreatic_Events<-read.table("Summary_Files//All_Events_Pan.txt",header=T)
...
Pan_GE<-Pan_GE[which(Pan_GE$gene_type != "ns"),]

#Making a list of DE and AS Genes
Pan<-list("DE"=Pan_GE$Genes,"AS"=unique(Pancreatic_Events$GeneID))
ggVennDiagram(Pan,color="black",label_alpha = 0,label_size = 2,edge_size = 0.5,set_size=2,label = "count")+
  ...
  theme(panel.background = element_blank(), 
        ...
        legend.background = element_blank(),
        axis.title = element_text(size=1, color="black"))
ggsave("Figures/2I_AS_GE_Overlap_Pan.pdf",width=1.5,height=0.75)
...
Ovarian_Events<-Ovarian_Events[which(Ovarian_Events$Total_Count_1>=30 & Ovarian_Events$Total_Count_2>=30 &
                                           Ovarian_Events$PValue<0.05 & Ovarian_Events$FDR<0.05),]
Ov_GE<-Ov_GE[which(Ov_GE$gene_type != "ns"),]


#Making a list of DE and AS Genes
Ov<-list("DE"=Ov_GE$Genes,"AS"=unique(Ovarian_Events$GeneID))

ggVennDiagram(Ov,color="black",label_alpha = 0,label_size = 2,edge_size = 0.5,set_size=2,label = "count")+
  ...
  theme(panel.background = element_blank(), 
        ...
        legend.background = element_blank(),
        axis.title = element_text(size=1, color="black"))
ggsave("Figures/2J_AS_GE_Overlap_Ov.pdf",width=1.5,height=0.75)
```

#Figure 2K - Overlap Between AS Skipped Exons Events
```{r}
rm(list=ls())
Pancreatic_Events<-read.table("Summary_Files/All_Events_Pan.txt",header=T)
Ovarian_Events<-read.table("Summary_Files/All_Events_Ov.txt",header=T)
...
ggVennDiagram(CE,color="black",label_alpha = 0,label_size = 2,edge_size = 0.5,set_size=2,label = "count")+
  ...
  theme(panel.background = element_blank(), 
        ...
        legend.background = element_blank(),
        axis.title = element_text(size=1, color="black"))
ggsave("Figures/2K_CE_Overlap.pdf",width=1.5,height=0.75)
```

#Figure 2L - Overlap Between AS Retained Introns Events
```{r}
rm(list=ls())
Pancreatic_Events<-read.table("Summary_Files/All_Events_Pan.txt",header=T)
Ovarian_Events<-read.table("Summary_Files/All_Events_Ov.txt",header=T)
...
ggVennDiagram(RI,color="black",label_alpha = 0,label_size = 2,edge_size = 0.5,set_size=2,label = "count")+
  scale_fill_gradient(low="white",high = "Gray")+
  scale_color_manual(values = c("PDAC" = "#8AA54E","HGSOC" ="#D5732E"))+
  theme(legend.position = "none")+
  theme(panel.background = element_blank(), 
...
ggsave("Figures/2L_RI_Overlap.pdf",width=1.5,height=0.75)
```
...
g1<-ggplot()+
  ...
  xlab("")
g1
ggsave("Figures/K562_Splicing_Map.pdf",g1,width=6,height=4)
...
g1<-ggplot()+
  ...
  xlab("")
g1
ggsave("Figures/HepG2_Splicing_Map.pdf",g1,width=6,height=4)
...
g1<-ggplot()+
  ...
  xlab("")
g1
ggsave("Figures/Ovarian_HepG2_Splicing_Map.pdf",g1,width=6,height=4)
...
g1<-ggplot()+
  ...
  xlab("")
g1
ggsave("Figures/Ovarian_K562_Splicing_Map.pdf",g1,width=6,height=4)
...
g1<-ggplot()+
  ...
  xlab("")
g1
ggsave("Figures/Pancrean_HepG2_Splicing_Map.pdf",g1,width=6,height=4)
...
g1<-ggplot()+
  ...
  xlab("")
g1
ggsave("Figures/Pancrean_K562_Splicing_Map.pdf",g1,width=6,height=4)
```
